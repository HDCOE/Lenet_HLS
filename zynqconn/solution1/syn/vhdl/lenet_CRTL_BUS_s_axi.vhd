...
entity lenet_CRTL_BUS_s_axi is
generic (
...
end entity lenet_CRTL_BUS_s_axi;
...
architecture behave of lenet_CRTL_BUS_s_axi is
    ...
    constant ADDR_START_DATA_0 : INTEGER := 16#18#;
    constant ADDR_START_CTRL   : INTEGER := 16#1c#;
