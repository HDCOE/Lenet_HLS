...
set C_modelName {forward_conv}
set C_modelType { void 0 }
set C_modelArgList {
	{ conv_layer_5_6_1_0_32_32_1_input_data_V int 16 regular {array 1024 { 1 3 } 1 1 }  }
	{ conv_layer_5_6_1_0_32_32_1_output_data_V int 16 regular {array 4704 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "conv_layer_5_6_1_0_32_32_1_input_data_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "conv_layer_5_6_1_0_32_32_1_output_data_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "conv_layer_5_6_1_0_32_32_1_input_data_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Padding_fu_235", "Port" : "in_V"}]},
			...
			{"Name" : "conv_layer_5_6_1_0_32_32_1_inpad_data_V", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Padding_fu_235", "Port" : "out_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Padding_fu_235", "Parent" : "0",
		"CDFG" : "Padding",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenet_mac_muladd_16s_16s_28ns_28_1_1_U3", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	conv_layer_5_6_1_0_32_32_1_output_data_V { ap_memory {  { conv_layer_5_6_1_0_32_32_1_output_data_V_address0 mem_address 1 13 }  { conv_layer_5_6_1_0_32_32_1_output_data_V_ce0 mem_ce 1 1 }  { conv_layer_5_6_1_0_32_32_1_output_data_V_we0 mem_we 1 1 }  { conv_layer_5_6_1_0_32_32_1_output_data_V_d0 mem_din 1 16 } } }
