...
set C_modelArgList {
	...
	{ in_V int 16 regular {array 1176 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ in_V_address0 sc_out sc_lv 11 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "in_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2533", "Max" : "2533"}
	, {"Name" : "Interval", "Min" : "2533", "Max" : "2533"}
]}
...
set Spec2ImplPortList { 
	...
	in_V { ap_memory {  { in_V_address0 mem_address 1 11 }  { in_V_ce0 mem_ce 1 1 }  { in_V_q0 mem_dout 0 16 } } }
}
